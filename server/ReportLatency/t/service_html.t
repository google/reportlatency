...
my $no_service_html = $store->service_html('null');
is($tidy->parse('empty_service',$no_service_html), undef, 'tidy service_html(null)');
...
my $service_html = $store->service_html('google.com');
is($tidy->parse('service',$service_html), undef, 'tidy service_html(google.com)');
