...
INSERT INTO tag(tag,service) VALUES('Mail','mail.google.com');
EOD
...
my $qobj = new ReportLatency::Tag($store,$begin,$end,'Mail');
isa_ok($qobj, 'ReportLatency::Tag');
