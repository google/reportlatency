#!/usr/bin/perl -w
#
# Test ReportLatency::Location.pm
#
...
INSERT INTO upload(location) VALUES("1.2.4.0");
...
my $qobj = new ReportLatency::Location($store,$begin,$end,'1.2.3.0');
isa_ok($qobj, 'ReportLatency::Location');
