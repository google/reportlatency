GRANT SELECT ON upload,navigation,navigation_request,update_request,location,match,notmatch,tag,report,report3,reportn,reportnr,reportur TO PUBLIC;
...
GRANT SELECT,UPDATE on upload_id_seq TO "reportlatency";
